...
using Ui.AutomationFramework.Entities.WebSiteEntities;
using Ui.AutomationFramework.Utils;

namespace Ui.AutomationFramework
{
    public static class Configuration
    {
        ...
        public static IConfiguration InitConfiguration()
        {
            var config = new ConfigurationBuilder()
                .AddJsonFile("appsettings.ui.json", false, true)
                .Build();
            return config;
        }
        ...
        {
            return InitConfiguration().GetSection(name);
        }
        ...
        {
            return GetAppConfigurationSection(nameof(UserLoginEntity)).Get<UserLoginEntity>();
        }
    }
}