                ...
                <div className="product">
                  <figure className="row product-summary">
                    <div className="col-xs-6 col-sm-4 col-lg-3 product-image">
                      {cartLine.variant.imageUrls ? (<img src={cartLine.variant.imageUrls[0]} />) : (cartLine.product.imageUrls && (<img src={cartLine.product.imageUrls[0]} />))}
                    </div>
                    ...
                    <div className="col-xs-12">
                      <div className="product-detail">
                        <h3 onClick={(e) => toggleBar(e)} className="detail-header">
                          Additional Information<i className="fa fa-caret-right" />
                        </h3>
                        <div className="detail-description">{cartLine.variant.description || cartLine.product.description}</div>
                      </div>
                    </div>
                  </div>
                </div>
