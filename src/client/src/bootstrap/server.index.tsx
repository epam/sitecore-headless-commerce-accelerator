...
const parseServerData = (data: string | object, viewBag: string | object) => {
  ...
  if (parsedViewBag.httpContext && parsedViewBag.httpContext.request && parsedViewBag.httpContext.request.querystring) {
    delete parsedViewBag.httpContext.request['querystring'];
  }
