        ...
        <ul>
          {checkoutSteps &&
            checkoutSteps.map((checkoutStep, checkoutStepIndex) => {
              ...
              const stepClassName = this.props.sitecoreContext.routeFields.checkoutStepName.value === checkoutStep.fields.checkoutStepName.value ? 'active' : '';
              return (
...
export const CheckoutNavigation2 = JSS.renderingWithContext(NavigationComponent);
