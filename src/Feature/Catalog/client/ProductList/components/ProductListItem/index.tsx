      ...
      <figure className="listing-grid-item">
        <div className="img-wrap">
          <img
            ...
            alt="product image"
          />
          <NavigationLink className="btn btn-green btn-quickView" to={`/product/${this.props.productId}`}>
            Quick View
          </NavigationLink>
          <NavigationLink className="btn btn-green btn-viewProduct" to={`/product/${this.props.productId}`}>
            View Product
          </NavigationLink>
        </div>
        <figcaption>
