...
import { GlobalProductSearchState } from './models';
...
export const productSearchTotalPageCount = (state: GlobalProductSearchState) =>
  productsSearch(state).totalPageCount || 0;
