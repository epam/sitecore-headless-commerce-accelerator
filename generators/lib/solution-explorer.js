...
class SolutionExplorer {
    ...
    addProjectsConfigurationPlatforms(projects, settings) {
        projects.forEach(project => 
            settings.buildConfiguration.forEach(configuration => this.solution = 
                this.addProjectConfigurationPlatform(project, configuration)));
        return this.solution;
    }
    ...
    addLayers(projects, settings) {
        this.solution = tabdownParser.parse(this.content, { linebreaks: true, indent: '\t' });

        this.solution = this.addProjects(projects);
        this.solution = this.addNestedProjects(projects);
        this.solution = this.addProjectsConfigurationPlatforms(projects.filter(project => project.projectTypeId == settings.codeProject), settings);
