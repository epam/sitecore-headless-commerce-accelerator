...
const mapStateToProps = (state: AppState): BillingStateProps => {
  ...
  const useForBillingAddress =
    stepValues.shipping && stepValues.shipping.options && stepValues.shipping.options.useForBillingAddress;
...
export const Billing2 = compose(connectedToStore, renderingWithContext)(BillingComponent);
