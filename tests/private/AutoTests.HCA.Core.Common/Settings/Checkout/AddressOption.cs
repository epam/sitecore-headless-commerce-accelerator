...
namespace AutoTests.HCA.Core.Common.Settings.Checkout
{
    public enum AddressOption
    {
        ...
        [EnumMember(Value = "A Saved Address")] SavedAddress,
        [EnumMember(Value = "Also use for billing address")] AlsoUseForBillingAddress,
        [EnumMember(Value = "Same As Shipping Address")] SameAsShippingAddress,
        [EnumMember(Value = "Save this address to")] SaveAddressToAccount
    }
