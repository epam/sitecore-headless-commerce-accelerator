...
export const ErrorHandler = <TProps extends {}>(WrappedComponent: React.ComponentClass<TProps> | React.Factory<TProps>): React.ComponentClass<TProps> => {
  return class ErrorHandlerWrapper extends React.Component<TProps, ErrorHandlerWrapperState> {
    ...
    public render() {
      if (this.state && this.state.hasError) {
        ...
        return <span dangerouslySetInnerHTML={{ __html: `<!-- Error inside ${componentName}. For more info please check the console -->` }} />;
      }
