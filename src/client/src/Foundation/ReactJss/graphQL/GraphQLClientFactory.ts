...
import { ApolloClient, ApolloClientOptions, ApolloLink, InMemoryCache, NormalizedCacheObject } from '@apollo/client';
...
export default function (
  ...
  if (!endpoint) {
    endpoint = `/HCA/api/graph/?sc_apikey=${process.env.API_KEY || ''}`;
  }
