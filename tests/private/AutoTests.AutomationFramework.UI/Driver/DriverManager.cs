...
namespace AutoTests.AutomationFramework.UI.Driver
{
    public static class DriverManager
    {
        ...
        public static void InitDriver(BrowserType type, DriverOptions driverOptions = null)
        {
            ...
            Log(LogLevel.Debug,
                "Driver initialized: " + type + " Configuration: " + UiConfiguration.TestsSettings.GridUrl);
        }
        ...
        private static IWebDriver GetRemoteDriver(BrowserType type, DriverOptions driverOptions, bool retry = true)
        {
            ...
            var gridAddress = UiConfiguration.TestsSettings.GridUrl;
            Log(LogLevel.Debug, "Grid address: " + gridAddress);
            try
            {
                return new RemoteWebDriver(new Uri(gridAddress), driverOptions?.ToCapabilities(),
        ...
        {
            return GetWaiter(UiConfiguration.TestsSettings.DefaultTimeout, TimeSpan.FromMilliseconds(500));
        }
