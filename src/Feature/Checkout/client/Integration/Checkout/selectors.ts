...
export const checkoutDeliveryInfo = (state: GlobalCheckoutState) => checkoutData(state).delivery;
export const checkoutShippingInfo = (state: GlobalCheckoutState) => checkoutData(state).shipping;
export const checkoutBillingInfo = (state: GlobalCheckoutState) => checkoutData(state).billing;
