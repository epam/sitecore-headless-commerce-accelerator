...
export const TwoColumn: FC<GridProps> = (props) => {
  ...
  return (
    <main>
      <div className={classnames('container', { [wrapperClass]: !!wrapperClass })}>
        <div className="row">
          <div className={firstColumnClass || 'col-md-8'}>
            <Placeholder name="w-col-1" rendering={rendering} />
          </div>
          <div className={secondColumnClass || 'col-md-4'}>
