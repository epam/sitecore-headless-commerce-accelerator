  ...
  return (
    <ul className={cnShipping('AddressOptions')}>
      <li className={cnShipping('AddressOption')}>
        <Radio
          className={cnShipping('RadioButton')}
        ...
        />
        <Text
          className={cnShipping('AddressOptionLabel')}
          field={{ value: 'A New Address' }}
          tag="label"
          htmlFor={radioButtonIds.newAddress}
        />
      </li>
      ...
      {isLoggedIn && (
        <li className={cnShipping('AddressOption')}>
          ...
          <Text
            className={cnShipping('AddressOptionLabel')}
            field={{ value: 'A Saved Address' }}
            tag="label"
            htmlFor={radioButtonIds.savedAddress}
          />
        </li>
      )}
    </ul>
