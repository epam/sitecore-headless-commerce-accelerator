...
namespace AutoTests.HCA.Tests.APITests.SearchTests
{
    ...
    [TestFixture]
    [Description("Product search Tests")]
    [ApiTest]
    public class ProductSearchTests : HcaApiTest
    {
        ...
        [Test]
        [Description("Find products by category id & by search keyword")]
        ...
        [Test]
        [Description("Find products by search keyword with brand facet")]
        ...
        [Test]
        [Description("Find products by category id with brand facet")]
        ...
        [Test]
        [Pairwise]
        [Description("Find products by category and order result by search field")]
