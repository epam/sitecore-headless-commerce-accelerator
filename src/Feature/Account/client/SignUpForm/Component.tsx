          ...
          <div className="row sign-up-form-content">
            <div className="col-md-12">
              <div className="account-created-message">
                ...
                <NavigationLink className="btn btn-outline-green" to="/account">
              ...
              <Form>
                ...
                <div className="form-field">
                  ...
                  {accountValidation.status === LoadingStatus.Loaded &&
                    accountValidation.invalid && <span className="form-field-error-message">{accountValidation.inUse ? 'Email is already in use!' : 'Email is invalid!'}</span>}
                </div>
                <div className="form-field">
