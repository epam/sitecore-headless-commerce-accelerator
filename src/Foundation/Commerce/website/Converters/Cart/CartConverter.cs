...
namespace HCA.Foundation.Commerce.Converters.Cart
{
    ...
    using Models.Entities.Adjustments;
    ...
    [Service(typeof(ICartConverter<Connect.Cart>), Lifetime = Lifetime.Singleton)]
    public class CartConverter : ICartConverter<Connect.Cart>
    {
        private readonly ICartMapper cartMapper;

        private readonly ICatalogService catalogService;

        public CartConverter(ICatalogService catalogService, ICartMapper cartMapper)
        {
        ...
        public Cart Convert(Connect.Cart source)
        {
            if (source == null)
            {
                return null;
