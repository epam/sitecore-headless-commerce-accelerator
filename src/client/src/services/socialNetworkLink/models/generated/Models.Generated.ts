...
export interface SocialNetworkLinkDataSource extends HeadlessDefinitions.BaseDataSourceItem {
  /// The Css Class field.
  /// Field Type: Single-Line Text
  /// Field ID: 5fb8c44b-7a28-4d89-a38e-738e35911baf
  cssClass: HeadlessDefinitions.TextField;
...
// Path: /sitecore/templates/HCA/Feature/Navigation/Social Network Links/Social Network Link
// ID: 656950e2-cdb1-4899-8106-067a6b76468b
export interface SocialNetworkLinkRenderingParams extends HeadlessDefinitions.BaseRenderingParam {
  /// The Css Class field.
  /// Field Type: Single-Line Text
  /// Field ID: 5fb8c44b-7a28-4d89-a38e-738e35911baf
  cssClass: string;
...
export interface SocialNetworksLinksDataSource extends HeadlessDefinitions.BaseDataSourceItem {
  /// The Links field.
  /// Field Type: Treelist
  ...
  sectionTitle: HeadlessDefinitions.TextField;
}

// Path: /sitecore/templates/HCA/Feature/Navigation/Social Network Links/Social Networks Links
// ID: 94fb0bb4-f041-45f7-a0ce-1e3899fc40e0
export interface SocialNetworksLinksRenderingParams extends HeadlessDefinitions.BaseRenderingParam {
  /// The Links field.
  /// Field Type: Treelist
  /// Field ID: 69e30764-9342-4ade-9c1b-db74d087537d
  links: string;
...
export interface SocialNetworksLinksFolderDataSource extends HeadlessDefinitions.BaseDataSourceItem {}

// Path: /sitecore/templates/HCA/Feature/Navigation/Social Network Links/Social Networks Links Folder
// ID: 06baa321-f0c9-4e47-933e-3c0ae7ba1d61
export interface SocialNetworksLinksFolderRenderingParams extends HeadlessDefinitions.BaseRenderingParam {}
...
export interface SocialNetworksLinksParamsDataSource extends HeadlessDefinitions.BaseDataSourceItem {
  /// The Container Class field.
  /// Field Type: Single-Line Text
  /// Field ID: 489896f2-c063-433a-aef0-980605450800
  containerClass: HeadlessDefinitions.TextField;

  /// The Show Title field.
  /// Field Type: Checkbox
  /// Field ID: 8ca8968a-f2ba-48d4-b589-b528fb251cc1
  showTitle: HeadlessDefinitions.Field<boolean>;

  /// The Title Class field.
  /// Field Type: Single-Line Text
  /// Field ID: 45f1d33d-bebd-4f5f-9548-ad78cf2ada54
  titleClass: HeadlessDefinitions.TextField;

  /// The Title Tag field.
  /// Field Type: Single-Line Text
  /// Field ID: cb67858c-b67c-422f-975d-aacb0e5f845d
  titleTag: HeadlessDefinitions.TextField;
}

// Path: /sitecore/templates/HCA/Feature/Navigation/Social Network Links/Social Networks Links Params
// ID: 49f79318-adc9-492b-82f2-e29fa8f5dfb1
export interface SocialNetworksLinksParamsRenderingParams extends HeadlessDefinitions.BaseRenderingParam {
  /// The Container Class field.
  /// Field Type: Single-Line Text
  /// Field ID: 489896f2-c063-433a-aef0-980605450800
