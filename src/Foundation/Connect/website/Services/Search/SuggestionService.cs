...
namespace HCA.Foundation.Connect.Services.Suggestion
{
    ...
    public class SuggestionService : ISuggestionService
    {
        ...
        public SuggestionResult GetSuggestions(SuggestionOptions suggestionOptions)
        {
            ...
            var suggestQueryOptions = this.suggestionMapper.Map<SuggestionOptions, SuggestHandlerQueryOptions>(suggestionOptions);
