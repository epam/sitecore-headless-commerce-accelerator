...
const connectedToStore = connect<OrderInformationState, OrderInformationDispatchProps, OrderInformationOwnProps>(
  mapStateToProps,
  mapDispatchToProps,
);

export const OrderInformation2 = compose(connectedToStore, renderingWithContext)(OrderInformationComponent);
