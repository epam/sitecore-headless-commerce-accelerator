...
namespace AutoTests.HCA.Tests.UITests.ChekoutTests.ChekoutShippingTests
{
    ...
    {
        public CheckoutShippingProductsInformationTests(BrowserType browserType, HcaUserRole hcaUserRole) : base(browserType)
        {
        ...
        [Test]
        public void BlankProductInformationTest()
        {
        ...
        [Test]
        public void VerifySumWithoutDiscountTest()
        {
        ...
        [Test]
        public void VerifySumWithDiscountTest()
        {
            _hcaWebSite.AddProductsToCartFromTestData(_products);
        ...
        [Test]
        public void VerifyOneProductTest()
        {
        ...
        [Test]
        public void VerifyTwoSameProductTest()
        {
            var product = _products.First();
            _hcaWebSite.AddProductToCart(product);
            _hcaWebSite.AddProductToCart(product);
        ...
        [Test]
        public void VerifySameProductWithDifferentVariantTest()
        {
