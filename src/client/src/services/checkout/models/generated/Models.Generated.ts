...
export interface CheckoutNavigationDataSource extends HeadlessDefinitions.BaseDataSourceItem {
  /// The Back To Link field.
  /// Field Type: General Link
  /// Field ID: cb7502d8-cf47-4919-a528-ac7dcc1b636a
  backToLink: HeadlessDefinitions.LinkField;

  /// The Checkout Steps field.
  /// Field Type: Multilist
  /// Field ID: 55a6fd7a-07be-4fcd-ab3a-138b4ecbdc6b
  checkoutSteps: HeadlessDefinitions.ItemList<HeadlessDefinitions.BaseDataSourceItem>;

  /// The Info Link field.
  /// Field Type: General Link
  /// Field ID: da2a953e-b11a-4be5-8dba-f2e2c45233b8
  infoLink: HeadlessDefinitions.LinkField;
}

// Path: /sitecore/templates/HCA/Feature/Checkout/Data Sources/Checkout Navigation
// ID: 57cfa14b-718e-43c4-a1e0-5553ec8000b8
export interface CheckoutNavigationRenderingParams extends HeadlessDefinitions.BaseRenderingParam {
  /// The Back To Link field.
  /// Field Type: General Link
  /// Field ID: cb7502d8-cf47-4919-a528-ac7dcc1b636a
  backToLink: string;
...
export interface CheckoutStepDataSource extends HeadlessDefinitions.BaseDataSourceItem {
  /// The Checkout Step Name field.
  /// Field Type: Single-Line Text
  /// Field ID: 69f49102-c8c0-4e55-8f8e-c9cb130071e4
  checkoutStepName: HeadlessDefinitions.TextField;
}

// Path: /sitecore/templates/HCA/Feature/Checkout/Abstract/_Checkout Step
// ID: 41bec638-40fe-4a75-ace5-f3377299d8fa
export interface CheckoutStepRenderingParams extends HeadlessDefinitions.BaseRenderingParam {
  /// The Checkout Step Name field.
  /// Field Type: Single-Line Text
  /// Field ID: 69f49102-c8c0-4e55-8f8e-c9cb130071e4
