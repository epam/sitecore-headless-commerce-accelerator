...
export type GetAllOrders = () => Action<Models.AllOrdersRequestPayload>;

export type GetAllOrdersRequest = () => Action<StatusPayload>;

export type GetAllOrdersSuccess = (allOrders: Commerce.Order[]) => Action<Models.AllOrdersSuccessPayload>;
