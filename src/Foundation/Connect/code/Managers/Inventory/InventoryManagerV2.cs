...
namespace Wooli.Foundation.Connect.Managers.Inventory
{
    ...
    [Service(typeof(IInventoryManagerV2), Lifetime = Lifetime.Singleton)]
    public class InventoryManagerV2 : BaseManager, IInventoryManagerV2
    {
        private readonly InventoryServiceProvider inventoryServiceProvider;

        public InventoryManagerV2(IConnectServiceProvider connectServiceProvider, ILogService<CommonLog> logService)
            : base(logService)
        {
