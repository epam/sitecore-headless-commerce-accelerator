...
namespace HCA.Foundation.Commerce.Builders.Search
{
    ...
    public class SuggestionOptionsBuilder : ISuggestionOptionsBuilder
    {
        private readonly ISuggesterConfigurationProvider suggesterConfigurationProvider;

        public SuggestionOptionsBuilder(ISuggesterConfigurationProvider suggesterConfigurationProvider)
        {
        ...
        public SuggestionOptions Build(string search)
        {
