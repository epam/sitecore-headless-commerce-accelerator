...
export interface SocialLinksOwnProps
  extends Jss.GraphQLRenderingWithParams<SocialNetworksLinksDataSource, SocialNetworksLinksParamsRenderingParams> {}
