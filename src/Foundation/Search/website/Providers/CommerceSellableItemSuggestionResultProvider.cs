...
namespace HCA.Foundation.Search.Providers
{
    ...
    [Service(typeof(ISuggestionResultProvider), Lifetime = Lifetime.Singleton)]
    public sealed class
        CommerceSellableItemSuggestionResultProvider : SuggestionResultProvider
    {
        public CommerceSellableItemSuggestionResultProvider(ICommerceTypeLoader commerceTypeLoader)
        {
