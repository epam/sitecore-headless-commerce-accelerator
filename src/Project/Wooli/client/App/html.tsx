  ...
  return (
    <html>
      <head>
        ...
        <link href={`${distPath}/project/wooli/client.css`} rel="stylesheet" />
        <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css" />
      </head>
      <body>
        <div id="app" dangerouslySetInnerHTML={{ __html: content }} />
        <script dangerouslySetInnerHTML={{ __html: `window.__data=${JSON.stringify(initialState)};` }} />
        <script src={`${distPath}/project/wooli/vendors.bundle.js`} />
        <script src={`${distPath}/project/wooli/client.bundle.js`} />
      </body>
    </html>
  );
};
