...
namespace AutoTests.AutomationFramework.UI.Core
{
    public class TestLogger
    {
        ...
        public static void Log(LogLevel logLevel, string text, Exception e = null)
        {
            ...
            else if (logLevel.Equals(LogLevel.Info)) GetThreadLogger().GetLogger("Info").Info(message);
        }
        ...
        public static void Dispose()
        {
            ...
            TestContext.AddTestAttachment(
                Path.Combine(UiConfiguration.TestsSettings.FullReportFolderPath, GetThreadLogger()._logFileNameDebug),
                "Debug");
            TestContext.AddTestAttachment(
                Path.Combine(UiConfiguration.TestsSettings.FullReportFolderPath, GetThreadLogger()._logFileNameInfo),
                "Info");
