...
import customRouterMiddleware from 'Foundation/ReactJss/SitecoreContext/routerMiddleware';
...
export default class AppStore {
  ...
  public constructor(preloadedState: DeepPartial<AppState>, ssr: boolean = false) {
    ...
    const store = createStore(makeRootReducer(this.routerHistory), preloadedState as AppState, enhancer);
