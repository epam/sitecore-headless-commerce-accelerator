...
namespace AutoTests.HCA.Core.UI.CommonElements
{
    public class FooterControl
    {
        ...
        {
            return _footerElement.IsPresent();
        }
        ...
        {
            VerifyLink(FindSocialNetworkLinkByName(socialNetwork.GetLinkName()), socialNetwork.GetLinkText(),
                socialNetwork.GetHref());
        }

        public void ChooseSiteLinkItem(string siteLinkName)
        {
            FindSiteLinkItemByName(siteLinkName).Click();
        }

        public void ChooseSocialNetworksItem(string socialNetworkName)
        {
            FindSocialNetworkLinkByName(socialNetworkName).Click();
        }
        ...
        {
            return new WebLink($"Footer site link {name}",
        ...
        {
            return new WebLink($"Footer social link {name}",
